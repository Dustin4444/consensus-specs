...
* [Test format philosophy](./#test-format-philosophy)
  ...
  * [<mark style="color:$info;">Test completeness</mark>](./#test-completeness)
...
* [`bls`](bls/)
* [`epoch_processing`](epoch_processing/)
* [`genesis`](genesis/)
* [`operations`](operations/)
* [`sanity`](sanity/)
* [`shuffling`](shuffling/)
* [`ssz_generic`](ssz_generic/)
* [`ssz_static`](ssz_static/)
...
* `runner`: where a generator is a _"producer"_, this is the _"consumer"_.
  * A `runner` focuses on _only one_ `type`, and each type has _only one_ `runner`.
...
The well known bls/shuffling/ssz\_static/operations/epoch\_processing/etc. Handlers can change the format, but there is a general target to test.
...
The format matches that of the `mainnet_config.yaml` and `minimal_config.yaml`, see the [`/configs`](../../configs/#format) documentation. Config values that are introduced at a later fork may be omitted from tests of previous forks.
